...
export function Landing() {
  return <main className="landing">
    ...
    <section className="editorial-cover"><div className="cover-copy"><div><p className="cover-kicker">Not all who wander, or wonder, are lost</p><h1 className="cover-title">MAKE<br/>YOUR<br/><em>MOVE.</em></h1></div><div><p className="cover-lead">ContestDB is a contest platform for people who care about the rules. Host a room, enter a bracket, submit the work, and let the database keep the score.</p><div className="cover-cta"><Link className="btn primary lg" to="/signup">Enter the index →</Link><Link className="btn lg" to="/login">I have a pass</Link></div></div></div><aside className="cover-index"><div><span className="cover-kicker">This edition</span><h2>THE<br/>COMPETITION<br/>ISSUE</h2></div><div className="cover-number">01</div><p className="cover-rules">RUN / RANK / FREEZE<br/>A contest system for IUT DBMS II<br/>Built around the record, not the hype.</p></aside></section>

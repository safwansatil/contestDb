...
BEGIN
    ...
    -- The creator becomes HOST. The host does not consume
    -- one of the moderator slots.
...
BEGIN
    ...
    -- Lock the contest row. Two simultaneous promotions
    -- cannot both claim the final moderator slot.
    ...
    -- Only check capacity when this action would add a
    -- new moderator.
